...
namespace DomainClasses.Mapping
{
    ...
    // QC_Pallet
    public class AutoPalletDetailsConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AutoPalletDetails>
    {
        public AutoPalletDetailsConfiguration()
            : this("dbo")
        {
        }

        public AutoPalletDetailsConfiguration(string schema)
        {
            ToTable("V_PR_AutoPalletDetails", schema);
